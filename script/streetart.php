  ...
  <div class="container-fluid1 p-5">
    <div class="row flex-lg-row flex-column">
      <div class="col-md-2 pt-3">
        <h1 class="mt-0">Street Art</h1>
      </div>
      <div class="col-lg-8 pt-3">
        <p>Street art is a dynamic form of visual expression that emerges in public spaces, often outside conventional
          art galleries. It encompasses a wide range of artistic styles and techniques, from murals and stencils to
          sculptures and installations. Street artists use urban environments as their canvas to convey social,
          political, or personal messages. Street art not only transforms cityscapes but also serves as a powerful means
          of cultural commentary, sparking conversations and challenging norms. It's a testament to the democratization
          of art, accessible to anyone who encounters it in the streets.</p>
      </div>
    </div>
  </div>
  ...
  <div class="container p-3">
    <div class="row">
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a7work1.jpg" alt="image">
            <div class="info">
              <h2>"Girl with a Balloon" (2002)</h2>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a9work3.jpg" alt="image">
            <div class="info">
              <h2>"Crack is Wack" (1986)</h2>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a7work2.jpg" alt="image">
            <div class="info">
              <h2>"Balloon Debate" (2004)</h2>
              <a href="artist7.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a8work2.jpg" alt="image">
            <div class="info">
              <h2>"Genial is riding a bike" (2017)</h2>
              <a href="artist8.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a7work3.jpg" alt="image">
            <div class="info">
              <h2>"Rage, Flower Thrower" (2005)</h2>
              <a href="artist7.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a9work2.jpg" alt="image">
            <div class="info">
              <h2>"Untitled (FDR NY)" (1984)</h2>
              <a href="artist9.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a9work1.jpg" alt="image">
            <div class="info">
              <h2>"The Last Rainforest" (1989)</h2>
              <a href="artist9.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a8work1.jpg" alt="image">
            <div class="info">
              <h2>"The Times They Are A-Changin" (2013)</h2>
              <a href="artist8.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a9work4.jpg" alt="image">
            <div class="info">
              <h2>"Radiant Baby" (1980)</h2>
              <a href="artist9.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a7work4.jpg" alt="image">
            <div class="info">
              <h2>"Devolved Parliament" (2019)</h2>
              <a href="artist7.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="wrapper">
          <div class="card">
            <img src="a8work3.jpg" alt="image">
            <div class="info">
              <h2>"Oscar Niemeyer" (2017)</h2>
              <a href="artist8.php" class="btn">Read More</a>
            </div>
          </div>
        </div>
